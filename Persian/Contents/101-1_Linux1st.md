...
- ماژول‌ها در مسیر `/lib/modules/$(uname -r)` ذخیره می‌شوند.
- ابزار **dmesg** برای مشاهده لاگ‌های مربوط به ماژول‌ها مفید است.
- برخی ماژول‌ها به صورت خودکار هنگام اتصال سخت‌افزار بارگذاری می‌شوند (مثلا **USB**).
